-- ─────────────────────────────────────────────────────────────
-- 2026-09-11 — destino do e-mail de repasse volta ao definitivo
--
-- Durante a montagem do envio o destino ficou em cleitonjussara@gmail.com
-- (caixa pessoal de quem aprova) para testar. Fluxo validado de ponta a
-- ponta pelo app, volta para a caixa da empresa que já estava prevista:
-- repasse@pmservicosagronomicos.com.br. Resto da função é idêntico à
-- migração 2026-09-11-email-repasse-insert.sql.
-- ─────────────────────────────────────────────────────────────
