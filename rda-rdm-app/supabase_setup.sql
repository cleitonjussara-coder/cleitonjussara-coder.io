...
-- ─── E-mail da solicitação de repasse (gatilho + Resend via pg_net) ─────
-- A chave da API fica no cofre do Supabase, nunca aqui. Veja
-- migrations/2026-09-10-email-repasse.sql para o passo a passo.
